(function (a) {
    ...
    var j = function () {
        ...
        $(".splash_text").html(c+"<span>%</span>");
        //console.log(c);
        $(".splash_bw").css({"height":(160-c)/2+"%"});
        
        $(".preload_bar_highlight").css({"width":c+"%"});
        //console.log($(".splash_bw").css("height"));
        a(jBar).stop().animate({
    ...
    var k = function () {
        a(jBar).stop().animate({
            width: "100%"
             ...
             $('html').css({"background-color":"#b64c10"});
           a(jOverlay).fadeOut(0, function () {
